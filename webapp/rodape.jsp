	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="fs-about">
					<div class="fs-logo">
						<a href="#"> <img src="img/logo-b-p.png" alt="">
						</a>
					</div>
...
<!-- 			</div> -->
		...
		<div class="copyright-text">
			<p>
				...
				Todos os direitos reservados | Este site foi feito por 
				<i class="fa fa-heart" aria-hidden="true"></i> João Paulo da Mata Mendes
				<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
			</p>
		</div>
	</div>

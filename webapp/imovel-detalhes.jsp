                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="pd-title">
                                    ...
                                    <div class="pt-price">R$ 289,0<span>/mês</span></div>
                                    <h3>Nome do imóvel </h3>
                                    <p><span class="icon_pin_alt"></span> Passagem Iracema</p>
                                </div>
                            </div>
<!--                             <div class="col-lg-6"> -->
<!--                                 <div class="pd-social"> -->
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                        <div class="tab-details">
                                            <ul class="left-table">
                                                <li>
                                                    <span class="type-name">Tipo do imóvel</span>
                                                    <span class="type-value">Casa</span>
                                                </li>
                                                <li>
                                                    <span class="type-name">Código</span>
                                                    <span class="type-value">#219</span>
                                                </li>
                                                <li>
                                                    <span class="type-name">Preço</span>
                                                    <span class="type-value">R$ 289,0/mês</span>
                                                </li>
                                                <li>
                                                    <span class="type-name">Ano cohnstrução</span>
                                                    <span class="type-value">2019</span>
                                                </li>
                                                <li>
                                                    <span class="type-name">Total de visitas</span>
                                                    <span class="type-value">05</span>
                                                </li>
                                                <li>
                                                    <span class="type-name">Corretor</span>
                                                    <span class="type-value">João Paulo da Mata Mendes</span>
                                                </li>
                                            </ul>
                                            <ul class="right-table">
                                                <li>
                                                    <span class="type-name">Área</span>
                                                    <span class="type-value">1200m²</span>
                                                </li>
                                                <li>
